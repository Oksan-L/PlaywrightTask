...
test.describe('Redmine homepage tests', () => {
  ...
  // 2️⃣ Main menu has 9 clickable links
  ...
  // 3️⃣ Homepage contains all required section titles
  ...
  // 4️⃣ Clicking “Activity” opens the correct page
  ...
  // 5️⃣ Clicking “Home” returns to the homepage from a random menu item
